...
if __name__ == "__main__":
    img_size = 256
    batch_size = 32
    train_path = '../input/stage1_all/'
    # test_path = '../input/stage1_test/'
    test_path = '../input/stage2_test_final_hard/'
    ...
    model.fit_generator(train_generator, steps_per_epoch=len(xtr)/6, epochs=80,
    ...
    sub.to_csv('sub_32.csv', index=False)