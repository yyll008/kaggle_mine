...
fe = concatenate([(emb_app), (emb_ch), (emb_dev), (emb_os), (emb_h), 
                 (emb_nc), (emb_ipc), (emb_ipac), (emb_ipaoc), (emb_X0), (emb_X3), (emb_X5),(emb_X6), (emb_X7),(emb_X8)])
...
model = Model(inputs=[in_app,in_ch,in_dev,in_os,in_h,in_nc,in_ipc,in_ipac,in_ipaoc,in_X0,in_X3, in_X5, in_X6, in_X7,in_X8], outputs=outp)
...
print("writing....")
sub.to_csv('15featVal25nm_all.csv',index=False)